...
这是一个从零基础开始的 12 周学习工作区，目标是把 AI 基础、机器学习代码、医学图像分析、光谱分析和冷冻电镜细胞相位变化图像处理连接起来。你可以按周学习，也可以把它当作以后做论文复现和项目实验的模板。
...
新增具体应用方向：冷冻电镜 cryo-EM 下细胞相位变化图像处理。学习重点包括低信噪比图像预处理、对比度增强、相位/强度变化量化、变化区域识别，以及用传统机器学习或 CNN 判断相位变化强弱。
...
- 医学 AI 和 cryo-EM 图像分析一定要重视数据划分、评价指标、成像噪声、漂移误差和可解释性。
